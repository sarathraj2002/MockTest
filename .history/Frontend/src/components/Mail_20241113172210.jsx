...
function OTPForm({ email, onOTPVerify }) {
  ...
  return (
    <div style={{ padding: '50px 20px', textAlign: 'center' }}>
      ...
      <form onSubmit={handleSubmit} style={formStyle}> <h2 style={{ marginBottom: '20px',color:'black' }}>Enter OTP</h2>
        <label style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '10px' ,color:'red'}}>OTP</label>
        <input
          type="text"
          value={otp}
